...
$$
f(x) = 1 \mbox{ for }  10 \le x \le 20
$$
and 

$$
f(x) = 0 \mbox{ for } x < 10 \mbox{ or } x > 20.
$$
...
```{r}
hist(xbar.realizations, freq = F, main = expression(paste('Histogram of 10,000 Draws of ',bar(X)[4])))
```
...
hist(xbar.realizations, freq = F, breaks = 10, main = expression(paste('Histogram of 10,000 Draws of ',bar(X)[n = 3])))
...
hist(xbar.realizations, freq = F, main = expression(paste('Histogram of 10,000 Draws of ',bar(X)[n = 10])), ylim = c(0,2))
...
hist(xbar.realizations, freq = F, main = expression(paste('Histogram of 10,000 Draws of ',bar(X)[n = 30])), ylim = c(0,4))
...
hist(xbar.realizations, freq = F, main = expression(paste('Histogram of 10,000 Draws of ',bar(X)[n = 50])), ylim = c(0,5))
