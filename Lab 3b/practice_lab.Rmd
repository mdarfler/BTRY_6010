---
title: 'Practice Lab (Lab 3): For Loops, If Statements, and Monte Carlo Simulation'
output:
  html_document:
    df_print: paged
---
...
#### Problem 5 (Try with TA in Lab 4)

Suppose you roll two dice.  Write a code chunk to see approximately what fraction of the time are neither of the two dice equal to 6.
