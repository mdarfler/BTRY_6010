...
```{r}
SpeedDating2 <- read.csv("https://raw.githubusercontent.com/mdarfler/BTRY_6010/master/Lab/Lab%2011/SpeedDating2(3).csv")
...
```
  ...
  $$Y_i = 0.29 - 0.06 X_{i1} + 0.41 X_{i2} + 0.15 X_{i3} + 0.14 X_{i4} + .27 X_{i5}$$
  ...
  0.29 - 0 + 0.41 * 7 + 0.15 * 5 + 0.14 * 0.27 * 0
 ...
 0.6565 amount of variability that our model explains. 
